    ...
    <div>
        <div class="row bg-tint my-3 py-3 align-items-center">
           ...
           <div class="col d-flex align-items-center justify-content-end">
                ...
                <input v-model="limit" type="number" id="per-page" @change="loadProducts(reloadPage = true)" class="form-control me-4" style="width: 5rem" min=4>
                <div class="me-2"> <small>Sort</small></div>
                <select v-model="sortOption" class="form-select w-50" aria-label="Default select example" @change="loadProducts(resetPage = true)">
        ...
        <div class="d-flex justify-content-center">
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item text-black" @click="handleNavigate" :class=" { disabled: currentPage == 1}"><a class="page-link text-black bg-tint" href="#"><span aria-hidden="true">&laquo;</span></a></li>
                    <li v-for="page in pageNumb" :key="page" class="page-item text-black" @click="handleNavigate"><a class="page-link text-black bg-tint" href="#" :class="{'current-active': currentPage == page}" > {{page}} </a></li>
                    <li class="page-item text-black" @click="handleNavigate" :class=" { disabled: currentPage == pageNumb }" ><a class="page-link text-black bg-tint" href="#" ><span aria-hidden="true">&raquo;</span></a></li>
                </ul>
            </nav>
        </div>
